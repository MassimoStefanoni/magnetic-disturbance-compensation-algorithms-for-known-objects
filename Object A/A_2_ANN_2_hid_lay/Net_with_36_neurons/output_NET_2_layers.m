...
net_xyz_MAE_bef=sum(sum(abs(out_Hx_(:,:))))/(41*41-15*15)+sum(sum(abs(out_Hy_(:,:))))/(41*41-15*15)+sum(sum(abs(out_Hz_(:,:))))/(41*41-15*15);
net_xyz_MAE=sum(sum(abs(out_e_Bx(:,:))))/(41*41-15*15)+sum(sum(abs(out_e_By(:,:))))/(41*41-15*15)+sum(sum(abs(out_e_Bz(:,:))))/(41*41-15*15);
...
csvwrite("Results_NET_2_layer.txt",out_net);
...
name_figure="eBx_heat_NET_2_layers.png";
...
zlabel(my_z_label,'Fontsize', my_myfontsize_label,'fontweight','bold');
%     xlim(my_xlim); %     zlim(my_zlim); %     xticks(my_xticks); %     yticks(my_yticks); %     zticks(my_zticks);
name_figure="eBy_heat_NET_2_layers.png";
...
zlabel(my_z_label,'Fontsize', my_myfontsize_label,'fontweight','bold');
%     xlim(my_xlim); %     zlim(my_zlim); %     xticks(my_xticks); %     yticks(my_yticks); %     zticks(my_zticks);
name_figure="eBz_heat_NET_2_layers.png";
