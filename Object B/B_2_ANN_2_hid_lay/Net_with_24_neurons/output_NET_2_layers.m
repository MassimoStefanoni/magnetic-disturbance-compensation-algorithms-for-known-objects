...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load netA_2_layers_24; %sim(netB_93,[1;1]);
net=netA_2_layers_24;
...
csvwrite("Results_out_NET_2_layers.txt",out_net);
...
surf(z.');
colorbar;
title('Two hidden layers ANN error B_X')
xlabel(my_x_label);
ylabel(my_y_label);
zlabel(my_z_label);
...
surf(z.');
colorbar;
title('Two hidden layers ANN error B_Y')
xlabel(my_x_label);
ylabel(my_y_label);
zlabel(my_z_label);
xlabel(my_x_label,'Fontsize', my_myfontsize_label,'fontweight','bold');
...
surf(z.');
colorbar;
title('Two hidden layers ANN error B_Z')
xlabel(my_x_label);
ylabel(my_y_label);
zlabel(my_z_label);
xlabel(my_x_label,'Fontsize', my_myfontsize_label,'fontweight','bold');
